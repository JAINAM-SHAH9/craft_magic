...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2024 at 11:31 AM
...
CREATE TABLE `orders` (
  ...
  `prod` varchar(200) CHARACTER SET latin1 NOT NULL,
...
--
-- Table structure for table `tblquerys`
--

CREATE TABLE `tblquerys` (
  `id` int(100) NOT NULL,
...
--
-- Dumping data for table `tblquerys`
--

INSERT INTO `tblquerys` (`id`, `name`, `gmail`, `number`, `message`, `status`, `send_date`) VALUES
(5, 'qewq', 'paresh@gamli.com', '7359951602', 'hello user not working', 0, '2024-01-02'),
(6, 'vaibhav dodiya', 'vaibhavydodiya@gmail.com', '9409535306', 'hii', 0, '2024-01-02'),
(7, 'Vaibhav Dodiya', 'admin@gmail.com', '9409535306', 'new ms', 0, '2024-01-06'),
(8, 'poojan', 'p23@gmail.com', '98789856', 'poojan trivedi', 0, '2024-01-10');
...
--
-- Indexes for table `tblquerys`
--
ALTER TABLE `tblquerys`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tblquerys`
--
ALTER TABLE `tblquerys`
