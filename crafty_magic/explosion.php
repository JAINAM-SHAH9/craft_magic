					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="scrapbook.php">ScrapBook</a>
								<a class="dropdown-item" href="handmade.php">HandMade Frames</a>
								<a class="dropdown-item" href="explosion.php">Explosion Box</a>
								<a class="dropdown-item" href="tagbook.php">Tag Book/Tag album</a>
							</div>
						</li>
