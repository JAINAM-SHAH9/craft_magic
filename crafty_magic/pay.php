<?php
	...
	{
		echo '<script>alert("you are not logged-in yet please sign in to visit.😊😊")</script>';
					...
					<div class="heading-title text-center">
						...
						<hr>
                            <form action="" method="post">
                                <input type="submit" value="Cash on delivery" name="payment">
                            </form>
					<!--	<?php 
                            if(isset($_POST["pay"]))
                            {
                                ...
                                // echo $email."<br>".$prod."<br>".$price."<br>".$id;
    
                                $insert="INSERT INTO orders (id,email,prod,price) VALUES ('$id','$email','$prod','$price');";
                                $insert_fire = mysqli_query($con,$insert);
                                if(!$insert_fire)
                                {
					...
					<?php 
                            if(isset($_POST["payment"]))
                            {
                                ...
                                else
                                {
                                    // header("location:")
                                    // echo "<script>window.history.back();</script>";
                                    echo "<script>alert('order has been recieved...')</script>";
