...
<head>
  ...
  <title>Crafter's Corner Admin</title>
  <!-- plugins:css -->
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <!--  <img src="images/newlogo.jpeg" alt="logo"> -->
              </div>
              <?php   session_start(); ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
  ...
  <form class="form-signin" method="POST">
    <h2 class="form-signin-heading text-center">Crafter's Corner Admin Login</h2>
...
<?php
    if(isset($_POST['submit']))
    {
      // session_start();
        ...
        {
          $_SESSION["adminlogindatabase"] = "admin";
