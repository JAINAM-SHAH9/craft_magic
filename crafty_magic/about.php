			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><li class="nav-item active"><a class="nav-link" href="about.php">About</a></li>
						<?php 
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><li class="nav-item active"><a class="nav-link" href="about.php">About</a></li>
